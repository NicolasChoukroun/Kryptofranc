...
unlocked to sign the kryptoFranc-Qt.app bundle.
...
allowing somebody to distribute a kryptoFranc-Qt.app or kryptofranc-qt-setup.exe with a valid
...
that the kryptofranc-qt.exe file inside the installer had not been tampered with.
