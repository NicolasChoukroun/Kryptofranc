...
kryptoFranc is an experimental new digital currency that enables instant payments to
...
the KryptoFranc software, see https://kryptofranc.org/en/download, or read the
...
The developer [mailing list](https://lists.linuxfoundation.org/mailman/listinfo/kryptofranc-dev)
should be used to discuss complicated or controversial changes before working
on a patch set.

Developer IRC can be found on Freenode at #kryptofranc-core-dev.
