...
#ifndef KRYPTOFRANC_KRYPTOFRANCCONSENSUS_H
#define KRYPTOFRANC_KRYPTOFRANCCONSENSUS_H
...
#define KRYPTOFRANCCONSENSUS_API_VER 0
...
#endif // KRYPTOFRANC_KRYPTOFRANCCONSENSUS_H
