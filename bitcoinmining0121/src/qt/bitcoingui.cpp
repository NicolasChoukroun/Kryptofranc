...
const QString kryptoFrancGUI::DEFAULT_WALLET = "~Default";

kryptoFrancGUI::kryptoFrancGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    clientModel(0),
    walletFrame(0),
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("KryptoFranc") + " - ";
#ifdef ENABLE_WALLET
...
void kryptoFrancGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kryptofranc: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About KryptoFranc"), this);
    aboutAction->setStatusTip(tr("Show information about KryptoFranc"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for KryptoFranc"));
    ...
    openAction->setStatusTip(tr("Open a kryptofranc: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KryptoFranc help message to get a list with possible kryptoFranc command-line options"));
...
void kryptoFrancGUI::setClientModel(ClientModel *clientModel)
{
...
#ifdef ENABLE_WALLET
bool kryptoFrancGUI::addWallet(const QString& name, WalletModel *walletModel)
{
    if(!walletFrame)
        return false;
...
bool kryptoFrancGUI::setCurrentWallet(const QString& name)
{
    if(!walletFrame)
        return false;
...
void kryptoFrancGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
#ifndef Q_OS_MAC
    trayIcon = new QSystemTrayIcon(this);
    QString toolTip = tr("KryptoFranc client") + " " + networkStyle->getTitleAddText();
...
void kryptoFrancGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to kryptoFranc network", "", count));
}

void kryptoFrancGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress)
{
    if(!clientModel)
        return;
...
#ifdef ENABLE_WALLET
void kryptoFrancGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address, const QString& label)
{
    ...
    menu(0)
{
    ...
    Q_FOREACH (const kryptoFrancUnits::Unit unit, units)
    {
        max_width = qMax(max_width, fm.width(kryptoFrancUnits::name(unit)));
    }
...
{
    menu = new QMenu();
    Q_FOREACH(kryptoFrancUnits::Unit u, kryptoFrancUnits::availableUnits())
    {
        QAction *menuAction = new QAction(QString(kryptoFrancUnits::name(u)), this);
...
{
    setText(kryptoFrancUnits::name(newUnits));
}
