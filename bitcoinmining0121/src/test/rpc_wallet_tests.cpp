...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CkryptoFrancAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CkryptoFrancAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CkryptoFrancAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CkryptoFrancAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CkryptoFrancAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CkryptoFrancAddress(arr[0].get_str()).Get() == demoAddress.Get());
