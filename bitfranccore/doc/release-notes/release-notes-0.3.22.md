...
Notable changes:
* Client will accept and relay TX's with 0.0005 KYF fee schedule (users still pay 0.01 KYF per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #kryptofranc00 - #kryptofranc99
