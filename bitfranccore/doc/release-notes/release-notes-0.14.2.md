KryptoFranc version 0.14.2 is now available from:

  <https://kryptofranc.org/bin/kryptofranc-core-0.14.2/>
...
(in KryptoFranc 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate kryptofranc-config.h as necessary (theuni)
