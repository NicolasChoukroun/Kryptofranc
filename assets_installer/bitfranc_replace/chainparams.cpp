...
{
        const char* pszTimestamp = "BitFranc 1/1/2019: La renaissance de la monnaie française";
...
public:
    CMainParams() {
            ...
            vSeeds.emplace_back("server1.bitfranc.net"); // Germany
            vSeeds.emplace_back("server1.bitfranc.net"); // Finland
            vSeeds.emplace_back("server1.bitfranc.net"); // Germany
