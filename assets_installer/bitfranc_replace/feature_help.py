...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitfranc with -h for help text")
        ...
        self.log.info("Start bitfranc with -version for version information")
        ...
        self.log.info("Start bitfrancd with -fakearg to make sure it does not start")
