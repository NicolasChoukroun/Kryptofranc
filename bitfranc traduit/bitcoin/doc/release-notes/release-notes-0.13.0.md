Bitfranc Core version 0.13.0 is now available from:
...
Various code modernizations have been done. The Bitfranc Core code base has
...
HD wallets are incompatible with older versions of Bitfranc Core.
...
proposed parameters, a future release of Bitfranc Core is expected that
