Bitfranc Core version 0.9.0 is now available from:
...
Rebranding to Bitfranc Core
---------------------------

To reduce confusion between Bitcoin-the-network and Bitcoin-the-software we
have renamed the reference client to Bitfranc Core.
