...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitfranc Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitfranc Core"
...
#define PACKAGE_NAME "Bitfranc Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitfranc Core 0.16.0"
