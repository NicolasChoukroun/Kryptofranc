...
By default, kryptofrancd will dump mempool on shutdown and
...
class MempoolPersistTest(kryptoFrancTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give kryptofrancd a second to reload the mempool
