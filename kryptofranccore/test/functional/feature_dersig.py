...
class BIP66Test(kryptoFrancTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # kryptofrancd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and kryptofrancd produces more specific reject
            # reasons.
