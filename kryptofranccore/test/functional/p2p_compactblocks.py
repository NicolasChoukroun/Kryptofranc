...
# TestP2PConn: A peer we use to send messages to kryptofrancd, and store responses.
...
class CompactBlocksTest(kryptoFrancTestFramework):
    ...
    # This test actually causes kryptofrancd to (reasonably!) disconnect us, so do this last.
    ...
    # kryptofrancd's choice of nonce.
    ...
    # Test that kryptofrancd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for kryptofrancd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # kryptofrancd will not send blocktxn responses for blocks whose height is
