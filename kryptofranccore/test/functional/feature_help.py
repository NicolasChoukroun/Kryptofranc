...
"""Verify that starting kryptofranc with -h works as expected."""

from test_framework.test_framework import kryptoFrancTestFramework
from test_framework.util import assert_equal

class HelpTest(kryptoFrancTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kryptofranc with -h for help text")
        ...
        self.log.info("Start kryptofranc with -version for version information")
        ...
        self.log.info("Start kryptofrancd with -fakearg to make sure it does not start")
