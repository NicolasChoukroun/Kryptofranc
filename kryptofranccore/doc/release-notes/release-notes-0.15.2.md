KryptoFranc version *0.15.2* is now available from:

  <https://kryptofranccore.org/bin/kryptofranc-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in kryptofranc-tx (TheBlueMatt)
