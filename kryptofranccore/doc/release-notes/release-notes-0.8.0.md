Kryptofranc-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/kryptofranc/files/Kryptofranc/kryptofranc-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Kryptofranc
...
New/changed settings (command-line or kryptofranc.conf file)
--------------------------------------------------------
