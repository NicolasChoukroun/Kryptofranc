KryptoFranc version 0.13.2 is now available from:

  <https://kryptofranc.org/bin/kryptofranc-core-0.13.2/>
...
- #8908 `4a974b2` Update kryptofranc-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow kryptofranc-tx to create v2 transactions (btcdrak)
