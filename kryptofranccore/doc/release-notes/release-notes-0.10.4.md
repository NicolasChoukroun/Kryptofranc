KryptoFranc version 0.10.4 is now available from:

  <https://kryptofranc.org/bin/kryptofranc-core-0.10.4/>
...
- #6953 `43c2789` Split kryptofranc-tx into its own package
