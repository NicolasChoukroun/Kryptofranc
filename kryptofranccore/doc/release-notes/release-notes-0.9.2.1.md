KryptoFranc version 0.9.2.1 is now available from:

  https://kryptofranc.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 KYF to 0.01 KYF
...
- Fix "Start kryptofranc on system login"
