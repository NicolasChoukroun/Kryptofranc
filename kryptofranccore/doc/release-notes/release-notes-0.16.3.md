KryptoFranc version 0.16.3 is now available from:

  <https://kryptofranccore.org/bin/kryptofranc-core-0.16.3/>
...
been discovered in KryptoFranc versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` kryptofrancconsensus: invalid flags error should be set to `kryptofrancconsensus_err` (afk11)
