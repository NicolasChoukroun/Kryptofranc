KryptoFranc version 0.16.1 is now available from:

  <https://kryptofranccore.org/bin/kryptofranc-core-0.16.1/>
...
- #12843 `df38b13` Test starting kryptofrancd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure kryptofrancd processes are cleaned up when tests end (sdaftuar)
