KryptoFranc version *0.15.0.1* is now available from:

  <https://kryptofranc.org/bin/kryptofranc-core-0.15.0.1/>

and

  <https://kryptofranccore.org/bin/kryptofranc-core-0.15.0.1/>
