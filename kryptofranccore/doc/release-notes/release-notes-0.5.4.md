Kryptofranc version 0.5.4 is now available for download at:
http://sourceforge.net/projects/kryptofranc/files/Kryptofranc/kryptofranc-0.5.4/
...
http://gitorious.org/kryptofranc/kryptofrancd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Kryptofranc-Qt notifications under Growl 1.3.
Increase required age of Kryptofranc-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxKryptofranc properly when installing Kryptofranc-Qt over it. (Windows)
