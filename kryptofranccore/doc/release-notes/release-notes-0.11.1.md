KryptoFranc version 0.11.1 is now available from:

  <https://kryptofranc.org/bin/kryptofranc-core-0.11.1/>
...
(see https://github.com/kryptofranc/kryptofranc/pull/6795).
...
one was randomly violated by all deployed kryptofranc software prior to
...
(see https://github.com/kryptofranc/kryptofranc/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libkryptofrancconsensus: avoid a crash in multi-threaded environments
