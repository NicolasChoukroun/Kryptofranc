...
#ifndef KRYPTOFRANC_INTERFACES_NODE_H
#define KRYPTOFRANC_INTERFACES_NODE_H
...
//! Top-level interface for a kryptofranc node (kryptofrancd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // KRYPTOFRANC_INTERFACES_NODE_H
