...
#ifdef ENABLE_WALLET
bool kryptoFrancGUI::addWallet(WalletModel *walletModel)
{
    if(!walletFrame)
        return false;
...
bool kryptoFrancGUI::removeWallet(WalletModel* walletModel)
{
...
bool kryptoFrancGUI::setCurrentWalletBySelectorIndex(int index)
{
...
void kryptoFrancGUI::setHDStatus(int hdEnabled)
{
...
void kryptoFrancGUI::toggleNetworkActive()
{
