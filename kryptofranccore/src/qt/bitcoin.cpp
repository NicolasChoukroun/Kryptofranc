...
{
    window = new kryptoFrancGUI(m_node, platformStyle, networkStyle, 0);
...
void kryptoFrancApplication::addWallet(WalletModel* walletModel)
{
#ifdef ENABLE_WALLET
...
void kryptoFrancApplication::removeWallet()
{
#ifdef ENABLE_WALLET
...
{
    QMessageBox::critical(0, "Runaway exception", KryptofrancGUI::tr("A fatal error occurred. Bitcoin can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int main(int argc, char *argv[])
{
    ...
    /// 6. Determine availability of data and blocks directory and parse kryptofranc.conf
