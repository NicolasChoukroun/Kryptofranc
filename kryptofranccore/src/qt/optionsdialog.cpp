    ...
    mapper(nullptr)
{
    ...
    ui->kryptofrancAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->kryptofrancAtStartup);
...
{
    /* Main */
    mapper->addMapping(ui->kryptofrancAtStartup, OptionsModel::StartAtStartup);
