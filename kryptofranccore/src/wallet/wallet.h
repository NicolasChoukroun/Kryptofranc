...
#ifndef KRYPTOFRANC_WALLET_WALLET_H
#define KRYPTOFRANC_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! kryptofranc from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this kryptofranc node, and set to 0 for transactions that were created
...
#endif // KRYPTOFRANC_WALLET_WALLET_H
