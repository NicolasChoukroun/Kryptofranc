...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " kryptofranc-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  kryptofranc-tx [options] <hex-tx> [commands]  Update hex-encoded kryptofranc transaction\n" +
            "or:     kryptofranc-tx [options] -create [commands]   Create hex-encoded kryptofranc transaction\n" +
            "\n";
