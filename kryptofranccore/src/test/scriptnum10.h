...
#ifndef KRYPTOFRANC_TEST_SCRIPTNUM10_H
#define KRYPTOFRANC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from KryptoFranc 0.10.0, for cross-comparison.
 */
public:
...
#endif // KRYPTOFRANC_TEST_BIGNUM_H
