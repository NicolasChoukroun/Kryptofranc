// Copyright (c) 2012-2018 The KryptoFranc developers
...
{
    BOOST_CHECK(TestSplitHost("www.kryptofranccore.org", "www.kryptofranccore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.kryptofranccore.org]", "www.kryptofranccore.org", -1));
    BOOST_CHECK(TestSplitHost("www.kryptofranccore.org:80", "www.kryptofranccore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.kryptofranccore.org]:80", "www.kryptofranccore.org", 80));
