 ...
 */
#ifndef KRYPTOFRANC_UTIL_H
#define KRYPTOFRANC_UTIL_H
...
extern const char * const KRYPTOFRANC_CONF_FILENAME;
extern const char * const KRYPTOFRANC_PID_FILENAME;
...
{
    std::string s = strprintf("kryptofranc-%s", name);
