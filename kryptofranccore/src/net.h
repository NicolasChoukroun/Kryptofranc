...
static const uint64_t MAX_UPLOAD_TIMEFRAME = 60 * 60 * 24; //60*60*24
...
static const unsigned int DEFAULT_MISBEHAVING_BANTIME = 60*60*24 ; // Default 24-hour ban 60 * 60 * 24;
